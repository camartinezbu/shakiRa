...
This package is a fork from [asteves tayloRswift package ](https://github.com/asteves/tayloRswift).
...
Color by discrete variable using default palette based on [Donde Están Los Ladrones?](https://en.wikipedia.org/wiki/D%C3%B3nde_Est%C3%A1n_los_Ladrones%3F)
...
[Fijación Oral Vol.2](https://en.wikipedia.org/wiki/Oral_Fixation,_Vol._2)
